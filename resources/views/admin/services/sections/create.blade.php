...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h1 class="h2 mb-2 text-dark">➕ Add Section to {{ $service->title }}</h1>
            <p class="text-muted mb-0">Create a new content section for this service's dedicated page</p>
        </div>
    ...
    <!-- Main Form -->
    <form method="POST" action="{{ route('admin.services.sections.store', $service) }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Describe this specific aspect of your service in detail...">{{ old('description') }}</textarea>
